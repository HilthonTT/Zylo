...
public abstract class NotificationType : Enumeration<NotificationType>
{
    ...
    public abstract Notification? TryCreateNotification(Event @event, Guid userId, DateTime utcNow);
    ...
    private class DayBeforeNotificationType : NotificationType
    {
        ...
        /// <inheritdoc />
        public override Notification? TryCreateNotification(Event @event, Guid userId, DateTime utcNow)
        {
